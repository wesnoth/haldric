...
func new_base(name: String, code: String, type: String, image_path: String, offset := Vector2()) -> void:
...
func new_village(name: String, code: String, type: String, image_path: String) -> void:
	var terrain := terrain_builder\
		.new_terrain()\
		.with_name(name)\
		.with_code(code)\
...
func new_castle(name: String, code: String, type: String, image_path: String) -> void:
	var terrain := terrain_builder\
		.new_terrain()\
		.with_name(name)\
		.with_code(code)\
...
func new_keep(name: String, code: String, type: String, image_path: String) -> void:
	var terrain := terrain_builder\
		.new_terrain()\
		.with_name(name)\
		.with_code(code)\
...
func new_transition(code, include: Array, exclude: Array, image_path: String) -> void:
