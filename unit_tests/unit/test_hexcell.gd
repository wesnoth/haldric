...
class TestConversions:
	...
	func test_offset_to_cube():
		assert_eq(Hex.hex_to_quad(Vector3(2, -3, 1)), Vector2(2,2), "Check positive cube to offset conversion")
		assert_eq(Hex.hex_to_quad(Vector3(-3, -5, 2)), Vector2(-3,0), "Check negative cube to offset conversion")
		assert_eq(Hex.quad_to_hex(Vector2(2, 2)), Vector3(2, -3, 1), "Check positive offset to cube conversion")
		assert_eq(Hex.quad_to_hex(Vector2(-3, -3)), Vector3(-3, 4, -1), "Check positive offset to cube conversion")
